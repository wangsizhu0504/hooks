...
import { useEventListener, useUrlParams } from '@kriszu/hooks'
import { categoryNames, functions } from '../../../meta'
...
const query = useUrlParams('hash-params', { removeFalsyValues: true })
